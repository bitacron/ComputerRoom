<template>
  <div class="app-container">
    ...
    <!-- 工具条 -->
    <div>
      <el-button type="danger" size="mini" @click="addRole()" v-if="hasPerm('role.add')">添加</el-button>
    ...
    <el-table
      ...
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <router-link :to="'/access/role/distribution/'+scope.row.id">
            <el-button type="info" size="mini" icon="el-icon-info" v-if="hasPerm('role.access')"></el-button>
          </router-link>
          <router-link :to="'/access/role/update/'+scope.row.id">
...
<script>
import roleApi from '@/api/access/role'
...
export default {
  ...
  methods: {
    ...
    addRole(){
      this.$router.push({ path: '/access/role/form' })
    },
